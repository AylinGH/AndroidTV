        ...
        onItemViewSelectedListener = OnItemViewSelectedListener { itemViewHolder, item, rowViewHolder, row ->
            ...
            if (item is MovieDb) {
                ...
                DoAsync(object : CompletedListener {
                    ...
                    movie = tmdb.movies.getMovie(item.id, "en-US")
                }
                ...
                DoAsync(object : CompletedListener {
                    ...
                    val c = tmdb.tvSeries.getSeries(item.id, "en")
                    val lastSeason = tmdb.tvSeasons.getSeason(c.id, c.seasons.last().seasonNumber, "en",
        ...
        DoAsync(object : CompletedListener {
            ...
            when (category.toLowerCase()) {
                array[0].toLowerCase() -> {
                    ...
                    val movieNowPlaying = tmdb.movies.getNowPlayingMovies("en-US", listMovieNowPlaying.page, "")
                    ...
                    val movieUpcoming = tmdb.movies.getUpcoming("en-US", listMovieUpcoming.page, "")
                    ...
                    val moviePopular = tmdb.movies.getPopularMovies("en-US", listMoviePopular.page)
                    ...
                    val movieTopRated = tmdb.movies.getTopRatedMovies("en-US", listMovieTopRated.page)
                ...
                array[1].toLowerCase() -> {
                    ...
                    val serialToday = tmdb.tvSeries.getAiringToday("en-US", listToday.page, null)
                    ...
                    val serialTv = tmdb.tvSeries.getOnTheAir("en-US", listTv.page)
                    ...
                    val serialPopular = tmdb.tvSeries.getPopular("en-US", listPopular.page)
                    ...
                    val serialTopRated = tmdb.tvSeries.getTopRated("en-US", listTopRated.page)
